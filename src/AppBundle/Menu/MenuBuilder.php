...
class MenuBuilder
{
    ...
    public function createParametersSidebarMenu(RequestStack $requestStack)
    {
        ...
        $submenu->addChild('libio.menu_label.channels_list', ['route' => 'admin_librinfo_ecommerce_channel_list']);
        $submenu->addChild(
            'libio.menu_label.shipping_methods_list',
        ...
        $submenu->addChild('libio.menu_label.shipping_methods_list', ['route' => 'admin_librinfo_ecommerce_shipping_method_list']);
