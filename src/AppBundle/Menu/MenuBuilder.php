...
class MenuBuilder
{
    ...
    public function createParametersSidebarMenu(RequestStack $requestStack)
    {
        ...
        $submenu->addChild('lisem.menu_label.crm_circles_list', ['route' => 'admin_librinfo_crm_circle_list']);
        $submenu->addChild('lisem.menu_label.crm_categories_list', ['route' => 'admin_librinfo_crm_category_list']);
        $submenu->addChild('lisem.menu_label.position_types_list', ['route' => 'admin_librinfo_crm_positiontype_list']);
        // $submenu->addChild('lisem.menu_label.phone_types_list', ['route' => 'admin_librinfo_crm_phonetype_list']);
        ...
        $submenu->addChild('lisem.menu_label.certifications_list', ['route' => 'admin_librinfo_seedbatch_certificationtype_list']);
        $submenu->addChild('lisem.menu_label.certificators_list', ['route' => 'admin_librinfo_seedbatch_certifyingbody_list']);
        ...
        $submenu->addChild('sil.stock.menu_label.operation_types', ['route' => 'admin_stock_operationtype_list']);
