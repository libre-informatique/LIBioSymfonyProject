...
class SeedBatchExtension extends BlastCoreExtension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('seed_batch', $config);

        // Entity code generators
        foreach (['seed_batch', 'seed_producer', 'plot', 'seed_farm'] as $cg) {
            $container->setParameter("seed_batch.code_generator.$cg",
                $container->getParameter('seed_batch')['code_generator'][$cg]
            );
        }
